...
function SchedulerSection({
  ...
  return (
    <div className="flex items-center gap-2">
      <CornerRightDownIcon className="h-4 w-4 text-muted-foreground" />
      <SchedulerDialog
        workflowId={workflowId}
        cron={cron}
        key={`${cron}-${workflowId}`}
...
function LastRunDetails({ workflow }: { workflow: Workflow }) {
  ...
  return (
    <div className="bg-primary/5 px-4 py-1 flex justify-center items-center text-muted-foreground">
